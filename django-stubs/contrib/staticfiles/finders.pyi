...
class BaseFinder:
    ...
    @overload
    def find(self, path: _PathType, all: Literal[False] = False) -> Optional[_PathType]: ...
...
class AppDirectoriesFinder(BaseFinder):
    ...
    def __init__(self, app_names: None = ..., *args: Any, **kwargs: Any) -> None: ...
    def find_in_app(self, app: str, path: _PathType) -> Optional[str]: ...
...
@overload
def find(path: str, all: Literal[False] = False) -> Optional[str]: ...
